...
face_cascade = cv2.CascadeClassifier('haarcascade_frontalface_default.xml') #Cargar el archivo de cascada para reconocer la cara
eye_casade = cv2.CascadeClassifier('haarcascade_eye.xml') #Cargar el archivo de cascada para reconocer los ojos

img = cv2.imread('imagenes/Gerardo.jpg') #Cargar la imagen
